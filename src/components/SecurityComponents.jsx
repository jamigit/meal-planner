...
export function SecurityHeaders({ 
  contentSecurityPolicy = "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://api.fontshare.com; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.netlify.app https://*.netlify.com https://api.emailjs.com http://localhost:* https://localhost:* ws://localhost:* wss://localhost:* https://localhost:*; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com https://api.fontshare.com;",
